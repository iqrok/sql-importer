...
/**
 * Failed Query
 * @typedef {Object} FailedQuery
 * @property {number} code - SQL Error number
 * @property {string} query - Failed SQL Query
 */
 ...
 * @property {String[]} functions - FUNCTION Queries
 * @property {String[]} procedures - PROCEDURE Queries
 * @property {String[]} triggers - TRIGGER Queries
 * @property {String[]} table - CREATE TABLE Queries
 * @property {String[]} alter - ALTER TABLE Queries
 * @property {String[]} view - CREATE VIEW Queries
 * @property {String[]} insert - INSERT INTO Queries, with each query grouped by table's name as key
 * @property {String[]} drop - DROP TABLE Queries
 * @property {String[]} sort - sorted table names based on table's dependencies
 * @property {String[]} misc - Miscellaneous Queries
 */
...
class SQL_IMPORTER {
	 ...
	 * @param {string} String containing SQL queries
	 * */
	sql(contents){
		const self = this;
	 ...
	 * Parse sql file
	 * @async
	 * @param {string} filepath - sql file's path
	 ...
	 * @async
	 * @private
	 * @param {string[]} queries - List of SQL Queries.
	 ...
	 * @param {boolean} [options.dropFirst=true] - whether perform wipe database first before import or not
	 * @param {boolean|string} [options.withData=true] - whether perform insert data or not. Set to 'single' to insert data individually
